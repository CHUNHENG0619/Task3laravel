...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <form method = "POST "action="<?php echo e(route('register')); ?>"></form>
            @crsf

            <div>
                <label for="name" value ="<?php echo e(__('Name')); ?>">
                <input id="name" class="block mt-1 w-full"
                type ="text" value="name" :value="old('name')"
...
<?php /**PATH C:\Laravel\form\resources\views/welcome.blade.php ENDPATH**/ ?>